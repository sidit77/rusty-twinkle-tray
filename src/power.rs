...
use windows::Win32::UI::WindowsAndMessaging::{
    CreateWindowExW, DefWindowProcW, DestroyWindow, IsWindow, RegisterClassW, DEVICE_NOTIFY_WINDOW_HANDLE, HMENU, HWND_MESSAGE, WINDOW_EX_STYLE,
...
unsafe extern "system" fn power_proc<F: FnMut(PowerEvent)>(
